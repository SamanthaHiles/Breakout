...
//  Breakout
//
//  Created by Samantha Hiles on 3/18/25.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makeBrick() {
        brick.removeFromParent() // remove the brick, if it exist
    ...
    func makeLabels() {
        ...
        scoreLabel.position = CGPoint(x: frame.midX - 50, y: frame.minY + 18)
        addChild(scoreLabel)
    }
}
